...
class MembersApi:
    ...
    def add_member(self, member: Member):
        self._logger.info("Attempting to add a member")
        try:
    ...
    def delete_member(self, member_id):
        self._logger.info("Attempting to delete a member")
        try:
    ...
    def update_status(self, new_status, member_id):
        self._logger.info("Attempting to update member status")
        try:
    ...
    def list_members_with_authorization(self, authorization):
        self._logger.info("Attempting to list all members given authorization")
        try:
    ...
    def get_all_members(self):
        self._logger.info("Attempting to list all members")
        try:
    ...
    def _members_array_json(cls, members: List[Member]):
        ...
        logger.info("Attempting to deserialize an array of JSON objects to Members array")
        try:
            json_data = []
